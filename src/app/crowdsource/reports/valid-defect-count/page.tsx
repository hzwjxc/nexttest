...
export default function ValidDefectCountPage() {
    ...
    // 获取提报有效缺陷数数据
    const { data, isLoading } = api.reports.getValidDefectCount.useQuery({
        page: currentPage,
    ...
    // 导出数据查询
    const { refetch: fetchExportData } = api.reports.exportValidDefectCount.useQuery(
        {
            startDate: startDate || undefined,
            endDate: endDate || undefined,
        },
    ...
    const handleExport = async () => {
        try {
            ...
            link.setAttribute(
                'download',
                `提报有效缺陷数_${startDate || '全部'}_${endDate || '全部'}.csv`
            );
