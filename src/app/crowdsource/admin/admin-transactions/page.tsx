...
const mockAdminTransactionData = Array.from({ length: 15 }, (_, i) => ({
    id: i + 1,
    transactionTime: '2024-09-19 12:23:00',
    adminName: '张三',
    adminAccount: '13526321245',
    user: '张三',
    userOAAccount: '015032674125',
    transactionType: '消费',
...
export default function AdminTransactionsPage() {
    ...
    const totalRecords = mockAdminTransactionData.length;
    const totalPages = Math.ceil(totalRecords / pageSize);
    const startIndex = (currentPage - 1) * pageSize;
    const endIndex = startIndex + pageSize;
    const currentData = mockAdminTransactionData.slice(startIndex, endIndex);
    ...
    const handleExport = () => {
        console.log('Export admin transaction data');
    };
        ...
        <Box bg={COLORS.bgSecondary} minH="100vh">
            <Container maxW="1200px" px={0}>
                ...
                <Flex
                    ...
                    mb={6}
                >
                    <Flex justify="space-between" align="center" gap={4} mr={2}>
                        <HStack gap={3} flex={1}>
                            <Input
                                placeholder="开始时间"
                                type="datetime-local"
                            ...
                            <select
                                ...
                                onChange={(e) =>
                                    setRechargeMethod(e.target.value)
                                }
                                style={{
                                    fontSize: '14px',
                                    borderRadius: '24px',
                            ...
                            >
                                ...
                                <option value="method1">补充奖励</option>
                                <option value="method2">其他方式</option>
                            </select>
